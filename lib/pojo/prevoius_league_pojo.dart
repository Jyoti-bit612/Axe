class PrevoiusLeaguePojo {
  bool? success;
  List<Data>? data;
  String? message;

  PrevoiusLeaguePojo({this.success, this.data, this.message});

  PrevoiusLeaguePojo.fromJson(Map<String, dynamic> json) {
...
class Data {
  ...
  Data.fromJson(Map<String, dynamic> json) {
    ...
    seasonType = json['season_type'] != null ? new SeasonType.fromJson(json['season_type']) : null;
  }
