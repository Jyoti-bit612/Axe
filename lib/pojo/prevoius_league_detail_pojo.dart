class PrevoiusLeagueDetailPojo {
  bool? success;
  ...
  PrevoiusLeagueDetailPojo(
      {this.success, this.matches, this.players,this.leagueDetails, this.message});

  PrevoiusLeagueDetailPojo.fromJson(Map<String, dynamic> json) {
