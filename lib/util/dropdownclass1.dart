...
class DropDownClass1 extends StatefulWidget {
  ...
  DropDownClass1(Color? color,String? name, String? dropDownValue, List? spinnerList, CallBackInterface? callInterface, String? onChangeNullOrNot, bool? elevation,bool? isExpanded) {
...
class DropDownClassState extends State<DropDownClass1> {
  @override
  void initState() {
    super.initState();
  }
